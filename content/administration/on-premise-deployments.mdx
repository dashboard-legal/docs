...
### Recommended Application Scaling

Please set the `num_app_replicas` value in the rcspec file to scale the environment appropriately.
If set to `2`, that will spin up 2 hasura containers, and 2 web containers, totalling 4 containers.

| Deployment               |   | Recommended | Min | Max |
| ----------               | - | ------------| ----| --- | 
| Micro (1 - 5  users)     |   | 2           | 1   | 3   |
| Small (5 - 20  users)    |   | 2           | 1   | 4   |
| Medium (20 - 50 users)   |   | 4           | 1   | 8   |
| Large (50+ users)        |   | 8           | 1   | 16  |


### Resource Requirements

When allocating resources, set the resource requirements to the `Required` column for the deployment size.
This will be the maximum that the application will require, although it's likely going to run at the `Estimated` level for most of the time.

| Deployment               |   | Resource   | Estimated  | Required    |
| ----------               | - | --------   | ---------- | ----------- |
| Micro (1 - 5  users)     |   | vCPU       | 2          | 4           | 
|                          |   | Memory     | 4GB        | 8GB         |
| Small (5 - 20  users)    |   | vCPU       | 4          | 8           | 
|                          |   | Memory     | 8GB        | 16GB        |
| Medium (20 - 50 users)   |   | vCPU       | 8          | 16          | 
|                          |   | Memory     | 16GB       | 32GB        |
| Large (50+ users)        |   | vCPU       | 16         | 32          | 
|                          |   | Memory     | 32GB       | 64GB        |
...
| ----------               | - | --------   | ----------- |
| Micro (1 - 5  users)     |   | Disc       | 12GB (Postgres 8GB, Minio 4GB\*)     |
| Small (5 - 20  users)    |   | Disc       | 28GB (Postgres 20GB, Minio 8GB\*)    |
| Medium (20 - 50 users)   |   | Disc       | 56GB (Postgres 40GB, Minio 16GB\*)   |
| Large (50+ users)        |   | Disc       | 152GB (Postgres 120GB, Minio 32GB\*) |
