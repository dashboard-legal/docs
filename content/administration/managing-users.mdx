...
## Client & Workstream Administration
The organization user management page governs which users have access to the organization. However, client and workstream boards have their own role-based access controls, with a similar role structure.

Any member of the organization can create a new client board, and they become the Owner of that board. They can then manage the settings of that client board, add other Members or Admins, or make the board public to all Members of the organization.

In the same manner, workstream boards have an Owner. This Owner does not need to be the same user as the Owner for the client board.

With flexible role-based access controls at the Organization, Client, and Workstream levels, you may set up Dashboard Legal in the way that makes the most sense for your team.
