...
2. Select "iManage Cloud", and you're good to go! It's really that simple!
3. To confirm that everything is set up properly, you can test the integration by pressing "Login to iManage"
