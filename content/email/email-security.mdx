...
Documents that are stored in your firm's DMS (iManage/Netdocs) are kept in the DMS and not stored on Dashboard Legal servers. They are purely visualized in Dashboard Legal Client/Workstream boards through the integration.
