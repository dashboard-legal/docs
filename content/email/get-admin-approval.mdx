...
> If you are a Microsoft administrator and are granting access to an employee to use Dashboard Legal, please read our [email security page](./email-security) and then follow the guide below.
