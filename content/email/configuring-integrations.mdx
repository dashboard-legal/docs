...
- Configures [SAML SSO](../administration/security-settings/#single-sign-on)
- Chooses the Exchange Service Account option in [Integration Settings](https://app.dashboardlegal.com/x/settings/integrations/)
- Configures the work server that hosts the Exchange server
- Saves the credentials for the service account
- Tests the integration on their own account in their [email settings](https://app.dashboardlegal.com/x/account/email/)
